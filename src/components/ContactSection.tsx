      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <AnimatedSection animation="fade-right" delay={100}>
              <div className="p-4 sm:p-6 bg-card rounded-lg border border-border">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-serif font-semibold text-foreground text-base sm:text-lg mb-1 sm:mb-2">Address</h3>
            ...
            <AnimatedSection animation="fade-right" delay={200}>
              <div className="p-4 sm:p-6 bg-card rounded-lg border border-border">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-serif font-semibold text-foreground text-base sm:text-lg mb-1 sm:mb-2">Phone</h3>
                    <a href="tel:07275036218" className="text-primary hover:text-primary/80 text-lg sm:text-xl font-medium">
                      072750 36218
                    </a>
                  </div>
                </div>
            ...
            <AnimatedSection animation="fade-right" delay={300}>
              <div className="p-4 sm:p-6 bg-card rounded-lg border border-border">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-serif font-semibold text-foreground text-base sm:text-lg mb-1 sm:mb-2">Business Hours</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Open Daily<br />
          ...
          <AnimatedSection animation="fade-left" delay={200}>
            <div className="h-[300px] sm:h-[400px] lg:h-full min-h-[300px] rounded-lg overflow-hidden border border-border">
              <iframe
